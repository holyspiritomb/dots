# Generated by Powerlevel10k configuration wizard on 2023-06-09 at 21:17 EDT.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='springgreen2'
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='grey0'
  # Custom icon.
  # typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='' # trans symbol
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND='grey11' #2
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND='grey11' #3
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='grey11' #2
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND='grey11'
  ...
  function my_git_formatter() {
    ...
    REMOTEPROTO=`echo $REMOTEURL | awk -F ':' '{print $1}'`
    unset GIT_REMOTE_TYPE
    unset VCS_STATUS_REMOTE_URL
    case $REMOTEPROTO in
        'git@gitlab.com')
            VCS_STATUS_REMOTE_URL=$(echo $REMOTEURL | sed 's/:/\//g;s/git@/https:\/\//g;s/.git$//g')
            GIT_REMOTE_TYPE='  '
            ;;
        'git@github.com')
            # VCS_STATUS_REMOTE_URL=$(echo $REMOTEURL | sed 's/:/\//g;s/git@/https:\/\//g;s/.git$//g')
            VCS_STATUS_REMOTE_URL=$REMOTEURL
            GIT_REMOTE_TYPE=' '
            ;;
        https|ssh)
            VCS_STATUS_REMOTE_URL=$REMOTEURL
            GIT_REMOTE_TYPE="$P9K_VISUAL_IDENTIFIER "
            ;;
    esac
    # Styling for different parts of Git status.
    # local       meta='%7F' # white foreground
    # local      clean='%2F' # grewn foreground
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      res+="${GIT_REMOTE_TYPE}${clean}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}"
    fi
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND='springgreen2'
